...
namespace qvp.StateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public ScreenManager(Game game) : base(game)
        {
            ...
            _backgroundTexture = _content.Load<Texture2D>("bg_mainmenu");
        }
        ...
        protected override void LoadContent()
        {
            ...
            Song = _content.Load<Song>("game-over-danijel-zambo-main-version-02-03-1394");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            SpriteBatch.Draw(_backgroundTexture, new Vector2(960, 960), new Rectangle(0, 0, 64, 64), Color.White, 0, new Vector2(64, 64), 15.0f, SpriteEffects.None, 0);
            SpriteBatch.End();
            foreach (var screen in _screens)
            {
